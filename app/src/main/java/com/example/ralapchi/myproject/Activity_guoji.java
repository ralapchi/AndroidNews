...
public class Activity_guoji extends SwipeBackActivity {
    public static final String URL = "http://v.juhe.cn/toutiao/index?type=guoji&key=9b66b37a560ac68ca037dfdec41207e0";
    /**
     * ListView对象
     */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout=(SwipeRefreshLayout)findViewById(R.id.swiperefresh_guoji);
        ...
        listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(Activity_guoji.this,NewsInfoActivity.class);
